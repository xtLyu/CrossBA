...
class MAML(BaseLearner):
    ...
    def adapt(self, loss, first_order=None, allow_unused=None, allow_nograd=None):
        ...
        if allow_nograd:
            ...
            grad_params = grad(loss, diff_params, retain_graph=second_order, create_graph=second_order,
    ...
    def clone(self, first_order=None, allow_unused=None, allow_nograd=None):
        ...
        return MAML(clone_module(self.module), lr=self.lr, first_order=first_order, allow_unused=allow_unused,
