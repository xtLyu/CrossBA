...
from attack.attack_data import induced_graphs_nodes_poison, multi_class_NIG_poison, multi_class_NIG_clean, \
    load_data4pretrain, load_tasks, load_backdoor_task
...
def data_process(dataname, num_trigger_node, node_classes, trigger_pattern):
    ...
    induced_graphs_nodes_poison(data, dataname=dataname, num_classes=node_classes, smallest_size=100,
                                largest_size=300, num_trigger_nodes=num_trigger_node, trigger_pattern=trigger_pattern)
...
def prompt_w_h_poison(backdoor_node_features, makeTE, target_embedding, device, num_trigger_node, pretext, folder_path,
                      ...
                      sim_thre=0):
    _, _, train_list, test_list = multi_class_NIG_clean(down_dataname, down_num_class, shots=200)
    ...
    poison_train_list, poison_test_list = multi_class_NIG_poison(down_dataname, down_num_class,
                                                                 shots=200)
...
def meta_test_adam(is_poison, meta_test_task_id_list, dataname, K_shot, seed, maml, gnn, adapt_steps_meta_test, lossfn,
    ...
    for task_1, task_2, support, query, _ in load_tasks('test', task_pairs, dataname, K_shot, seed):
        ...
        task_1_b, task_2_b, query_b, _ = next(load_backdoor_task('test', task_pairs, dataname, K_shot, seed))
...
if __name__ == '__main__':
    ...
    folder_path = f'./results/dataset/{args.predataset}_{args.downdataset}_{current_time}_{args.gnn_type}_{args.usage_par}_{args.defense_mode}_{args.sim_thre}_{args.attack_type}_{args.makeTE}_{args.poisoned_node}_{args.reg_param_trigger_n}_{args.reg_param_trigger_f}_{args.reg_param_gnn}'
    folder_paths = f'./results/dataset/{args.predataset}_{args.downdataset}_{current_time}_{args.gnn_type}_{args.usage_par}_{args.defense_mode}_{args.sim_thre}_{args.attack_type}_{args.makeTE}_{args.poisoned_node}_{args.reg_param_trigger_n}_{args.reg_param_trigger_f}_{args.reg_param_gnn}/pic_result'
