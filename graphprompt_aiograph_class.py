...
def prompt_w_h_poison(backdoor_node_features, makeTE, target_embedding, device, num_trigger_node, folder_path,
    ...
    _, _, train_list, test_list = attack_data.multi_class_NIG_clean_class_aio(dataname, down_class_list, shots=100)
    ...
    poison_train_list, poison_test_list = attack_data.multi_class_NIG_poison_class_aio(dataname, down_class_list,
                                                                                       shots=100)
