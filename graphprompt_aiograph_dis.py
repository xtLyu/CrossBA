...
def prompt_w_h_poison(backdoor_node_features, makeTE, target_embedding, device, num_trigger_node, folder_path,
                      dataname="CiteSeer", gnn_type="TransformerConv", num_class=6, is_poison=True, defense_mode="none",
                      sim_thre=0):
    _, _, train_list, test_list = attack_data.multi_class_NIG_clean_aiolevel(dataname, num_class, shots=100)
    ...
    poison_train_list, poison_test_list = attack_data.multi_class_NIG_poison_aiolevel(dataname, num_class, shots=100)
