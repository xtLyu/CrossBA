...
def our_badpretrain(device, num_class, reg_param_gnn, folder_path, num_trigger_node, makeTE, gnn_type, dataname,
    ...
    conloss = pt.train(dataname, graph_list, folder_path, batch_size=batch_size, lr=0.01, decay=0.00001, epochs=200)
    ...
    for epoch in range(1, 1 + 1):
        for inter_epoch in range(1, 1000 + 1):
...
def prompt_w_h_poison(backdoor_node_features, makeTE, target_embedding, device, num_trigger_node, folder_path,
    ...
    _, _, train_list, test_list = attack_data.multi_class_NIG_clean_aiolevel(down_dataname, down_num_class, shots=100)
    ...
    poison_train_list, poison_test_list = attack_data.multi_class_NIG_poison_aiolevel(down_dataname, down_num_class,
                                                                                      shots=100)
...
if __name__ == '__main__':
    ...
    folder_path = f'./results/aiolevel_app/{args.predataset}_{args.downdataset}_{current_time}_{args.gnn_type}_{args.usage_par}_{args.defense_mode}_{args.sim_thre}_{args.attack_type}_{args.makeTE}_{args.poisoned_node}_{args.reg_param_trigger_n}_{args.reg_param_trigger_f}'
    folder_paths = f'./results/aiolevel_app/{args.predataset}_{args.downdataset}_{current_time}_{args.gnn_type}_{args.usage_par}_{args.defense_mode}_{args.sim_thre}_{args.attack_type}_{args.makeTE}_{args.poisoned_node}_{args.reg_param_trigger_n}_{args.reg_param_trigger_f}/pic_result'
