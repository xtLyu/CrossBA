...
from attack.attack_data import induced_graphs_nodes_poison, multi_class_NIG_poison, multi_class_NIG_clean, \
    load_data4pretrain_aiograph, load_tasks, load_backdoor_task
...
def our_badpretrain(device, num_class, reg_param_gnn, folder_path, num_trigger_node, makeTE, pretext,
    ...
    graph_list, input_dim, hid_dim = load_data4pretrain_aiograph(dataname, [0, 1, 2, 3, 4, 5], 50)
...
def model_create(is_poison, dataname, gnn_type, num_class, folder_path, pretext, task_type='multi_class_classification',
    ...
    if task_type in ['multi_class_classification', 'regression']:
        ...
        if tune_answer:
            ...
            headlr = 0.01
            logger.info('head:{}'.format(headlr))
            opi_answer = optim.Adam(filter(lambda p: p.requires_grad, answering.parameters()), lr=headlr,
...
def prompt_w_h_poison(backdoor_node_features, makeTE, target_embedding, device, num_trigger_node, pretext, folder_path,
    ...
    _, _, train_list, test_list = multi_class_NIG_clean(dataname, num_class, shots=200)
    ...
    poison_train_list, poison_test_list = multi_class_NIG_poison(dataname, num_class, shots=200)
...
if __name__ == '__main__':
    ...
    folder_path = f'./results/aiograph_level/{args.dataset}_{current_time}_{args.gnn_type}_{args.usage_par}_{args.defense_mode}_{args.sim_thre}_{args.attack_type}_{args.makeTE}_{args.poisoned_node}_{args.reg_param_trigger_n}_{args.reg_param_trigger_f}_{args.reg_param_gnn}'
    folder_paths = f'./results/aiograph_level/{args.dataset}_{current_time}_{args.gnn_type}_{args.usage_par}_{args.defense_mode}_{args.sim_thre}_{args.attack_type}_{args.makeTE}_{args.poisoned_node}_{args.reg_param_trigger_n}_{args.reg_param_trigger_f}_{args.reg_param_gnn}/pic_result'
    ...
    if args.usage_par == 'prompt':
        ...
        meta_train_maml(train_meta_epoch, backdoor_maml, backdoor_gnn, backdoor_lossfn, backdoor_opt,
                        down_meta_train_task_id_list, args.dataset, adapt_steps=adapt_steps, K_shot=200)
