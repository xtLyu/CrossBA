...
def model_create(is_poison, pre_dataname, gnn_type, down_num_class, folder_path, pretext, token_num,
...
def prompt_w_h_poison(backdoor_node_features, makeTE, target_embedding, device, num_trigger_node, pretext, folder_path,
    ...
    gnn, PG, opi_pg, lossfn, answering, opi_answer = model_create(is_poison, pre_dataname, gnn_type, down_num_class,
                                                                  folder_path, pretext, token_num, task_type, True)
    answering.to(device)
...
if __name__ == '__main__':
    ...
    parser.add_argument("--predataset", type=str, default="Photo",
                        choices=['Computers', 'PubMed', 'Cora', 'Photo', 'CiteSeer'])
    parser.add_argument("--downdataset", type=str, default="CiteSeer",
                        choices=['CiteSeer', 'Computers', 'PubMed', 'Cora', 'Photo'])
    ...
    parser.add_argument("--token_num", type=int, default=15)
    ...
    folder_path = f'./results/application/{args.predataset}_{args.downdataset}_{current_time}_{args.gnn_type}_{args.usage_par}_{args.defense_mode}_{args.sim_thre}_{args.attack_type}_{args.makeTE}_{args.poisoned_node}_{args.reg_param_trigger_n}_{args.reg_param_trigger_f}_{args.reg_param_gnn}'
    folder_paths = f'./results/application/{args.predataset}_{args.downdataset}_{current_time}_{args.gnn_type}_{args.usage_par}_{args.defense_mode}_{args.sim_thre}_{args.attack_type}_{args.makeTE}_{args.poisoned_node}_{args.reg_param_trigger_n}_{args.reg_param_trigger_f}_{args.reg_param_gnn}/pic_result'
    ...
    if args.usage_par == 'prompt':
        ...
        train_meta_epoch = 30
        adapt_steps_meta_test_epoch = 30
        ...
        meta_test_adam(is_poison=True, meta_test_task_id_list=down_meta_test_task_id_list, dataname=args.downdataset,
                       ...
                       adapt_steps_meta_test=adapt_steps_meta_test_epoch,
